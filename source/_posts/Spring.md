...
![image-20220224125729704](image-20220224125729704.png)
...
![image-20220224115634817](image-20220224115634817.png)
...
public class testAdd {
    public static void main(String[] args) {
        ...
        //2 获取配置创建的对象
        User user=context.getBean("add",User.class);
        user.add();
    }
}
```
...
![image-20220224130149999](image-20220224130149999.png)
...
![image-20220224130750885](image-20220224130750885.png)
...
![image-20220224131105187](image-20220224131105187.png)
...
![image-20220224132429079](image-20220224132429079.png)

第二步 进行属性注入，在 bean 标签里面进行操作

![image-20220224132457197](image-20220224132457197.png)
...
![image-20220224160842015](image-20220224160842015.png)
...
![image-20220225102834305](image-20220225102834305.png)
...
![image-20220225103142039](image-20220225103142039.png)
...
![image-20220225103728233](image-20220225103728233.png)
...
![image-20220225104416855](image-20220225104416855.png)
...
![image-20220225105400809](image-20220225105400809.png)
...
![image-20220225105852025](image-20220225105852025.png)
...
![image-20220225111355412](image-20220225111355412.png)
...
![image-20220225111600872](image-20220225111600872.png)

第二种 没有接口情况，使用 CGLIB 动态代理

创建子类的代理对象，增强类的方法

![image-20220225111728667](image-20220225111728667.png)

## AOP（JDK 动态代理）

1、使用 JDK 动态代理，使用 Proxy 类里面的方法创建代理对象

![image-20220225112911371](image-20220225112911371.png)

（1）调用 newProxyInstance 方法

![image-20220225112951639](image-20220225112951639.png)
...
![image-20220225113722936](image-20220225113722936.png)

2、切入点

![image-20220225113816445](image-20220225113816445.png)

3、通知（增强）

![image-20220225113937455](image-20220225113937455.png)

![image-20220225114009234](image-20220225114009234.png)



4、切面

![image-20220225114114573](image-20220225114114573.png)
...
![image-20220225115210818](image-20220225115210818.png)
...
![image-20220225131719225](image-20220225131719225.png)
...
![image-20220225132736836](image-20220225132736836.png)
...
![image-20220225132846210](image-20220225132846210.png)
...
![image-20220225133059554](image-20220225133059554.png)
...
![image-20220225133431260](image-20220225133431260.png)
...
![image-20220225133629235](image-20220225133629235.png)
...
![image-20220225134213534](image-20220225134213534.png)
...
![image-20220225135027830](image-20220225135027830.png)

1、创建数据库表，添加记录

![image-20220225135121198](image-20220225135121198.png)
...
![image-20220225141458445](image-20220225141458445.png)
...
![image-20220225141630748](image-20220225141630748.png)
...
![image-20220225141912530](image-20220225141912530.png)
...
![image-20220225142443972](image-20220225142443972.png)

2、propagation：事务传播行为

（1）多事务方法直接进行调用，这个过程中事务 是如何进行管理的

![image-20220225142640251](image-20220225142640251.png)

![image-20220225142756964](image-20220225142756964.png)

![image-20220225142836566](image-20220225142836566.png)
...
![image-20220225143256174](image-20220225143256174.png)

（4）==不可重复读：==一个未提交事务读取到另一提交事务修改数据

![image-20220225143333752](image-20220225143333752.png)

（5）==虚读：==一个未提交事务读取到另一提交事务添加数据

（6）解决：通过设置事务隔离级别，解决读问题

![image-20220225143648650](image-20220225143648650.png)

![image-20220225143709508](image-20220225143709508.png)
...
![image-20220225144456891](image-20220225144456891.png)
...
![image-20220225144859270](image-20220225144859270.png)

（3）注解使用在方法参数里面，方法参数可以为空

![image-20220225144928158](image-20220225144928158.png)

（4）注解使用在属性上面，属性值可以为空

![image-20220225145017436](image-20220225145017436.png)
...
![image-20220225145251852](image-20220225145251852.png)
...
![image-20220225145442865](image-20220225145442865.png)
...
![image-20220225145728562](image-20220225145728562.png)
...
![image-20220225150420303](image-20220225150420303.png)
...
![image-20220225150730270](image-20220225150730270.png)
...
![image-20220225151021360](image-20220225151021360.png)
...
+ 对数据流进行一道道操作，成为操作符，比如工厂流水线 
  ...
  ![image-20220225151241087](image-20220225151241087.png)

  + 第二 flatMap 元素映射为流
    + 把每个元素转换流，把转换之后多个流合并大的流

  ![image-20220225151325721](image-20220225151325721.png)
...
+ BIO
  ...
  ![image-20220225151531578](image-20220225151531578.png)

+ NIO

  ![image-20220225151555254](image-20220225151555254.png)
...
![image-20220225151658737](image-20220225151658737.png)

![image-20220225151732310](image-20220225151732310.png)
...
![image-20220225152054657](image-20220225152054657.png)

第二步 配置启动端口号

![image-20220225152132933](image-20220225152132933.png)

第三步 创建包和相关类

+ 实体类

  ![image-20220225152254202](image-20220225152254202.png)
